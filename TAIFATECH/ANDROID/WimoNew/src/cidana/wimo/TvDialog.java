...
public class TvDialog extends Activity {
	...
	private OnClickListener btnYesAct = new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			WiMoCapture scrnCap = mCapContainer.getScrnCap();
			
			switch(mListIndex)
			{
			case 0:
				scrnCap.setTVRotate(scrnCap.CURRENT_TV_ROTATE_0);
				break;
			case 1:
				scrnCap.setTVRotate(scrnCap.CURRENT_TV_ROTATE_90);
				break;
			case 2:
				scrnCap.setTVRotate(scrnCap.CURRENT_TV_ROTATE_270);
				break;
			}
